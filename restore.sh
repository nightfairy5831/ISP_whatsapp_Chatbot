...
START_DATE="2025-10-7"  # YYYY-MM-DD
...
commit_messages=(
    ...
    "Update package.json"
    "feat: create index.js"
    "feat: recover original state"
    "feat: add multi language support"
    "feat: update language settings"
    "feat: update bot UI"
    "feat: update account info"
    "feat: add account balance"
    "feat: update customer plan and balance"
    "feat: create statistics info for data usage"
    "fix: get customer data"
    "fix: update language setting"
    "fix: upgrade language configuration"
    "fix: upgrade json configuration"
    "fix: upgrade vercel settings"
